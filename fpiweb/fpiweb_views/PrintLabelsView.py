"""
PrintLabelsView.py - manage the view to print QR codes on labels or paper.
"""
    ...
    def compute_box_dimensions(self):
        ...
        for vertical_position in range(vertical_start, -1,
            ...
            for horizontal_position in range(PAGE_OFFSET.x,
                                             horizontal_stop,
                                             BACKGROUND_SIZE.x):
                new_label: Point = LabelPosition(Point(horizontal_position,
                                                vertical_position))
